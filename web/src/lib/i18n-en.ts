...
export const EN_DICT: Record<string, string> = {
  ...
  "确认重启": "Confirm Reboot",
  "确认重启模组": "Confirm Modem Restart",
  "立即轮换": "Rotate Now",
  "立即重启": "Reboot Now",
  "立即重启模组": "Restart Modem Now",
  "确定重启 {id} 的模组？仅重启 modem（约 20 秒），不会重启整个设备，重启后会自动重新检测 SIM 卡。": "Restart the modem of {id}? Only the modem is restarted (about 20 seconds); the device itself is not rebooted, and the SIM card will be re-detected automatically afterwards.",
  "模组重启指令已送达，正在重新检测 SIM 卡": "Modem restart command delivered; re-detecting the SIM card",
